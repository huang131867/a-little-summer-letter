...
一个送给女朋友的互动照片网页：照片、小小真人版的你、鼠标星光、回忆章节、新剪辑视频和最后一封完整展开的信。

## 内容亮点

- 第一屏使用花墙照片做沉浸式主视觉。
- 原来的 3D 建模区已换成真人照片做成的 Q 版互动小人。
- 鼠标移动会生成星光和小心心，照片卡片会跟随指针微倾斜。
- 精选照片被整理成花墙、水族馆、美术馆、学习、镜子、一起出游等章节。
- 视频已按新照片重新剪辑，位于 `public/video/summer-letter.mp4`。
